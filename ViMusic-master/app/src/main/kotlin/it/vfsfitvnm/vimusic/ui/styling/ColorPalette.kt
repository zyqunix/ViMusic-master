...
val PinkColorPalette = ColorPalette(
    background0 = Color(0xff462d5e),
    background1 = Color(0xff7b5f8e),
    background2 = Color(0xffb478ff),
    text = Color(0xff212121),
    textSecondary = Color(0xff656566),
    textDisabled = Color(0xff9d9d9d),
    accent = Color(0xff5055c0),
...
fun colorPaletteOf(
    ...
    return when (colorPaletteName) {
        ...
        ColorPaletteName.Pink -> PinkColorPalette
    }
}
